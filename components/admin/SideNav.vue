<template>
    <div>
      <div class="grid lg:grid-cols-1 border-r" >
        <!-- Left Column -->
        <!-- <UButton class="lg:hidden" icon='i-heroicons-bars-4' color="gray" variant="ghost" @click="toggleCollapse" /> -->
        <UButton class="lg:justify-end" icon='i-heroicons-chevron-double-left' color="gray" variant="ghost" @click="toggleCollapse" />
